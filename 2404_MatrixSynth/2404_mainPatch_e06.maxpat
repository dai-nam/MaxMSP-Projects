...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 573.0, 961.0, 51.0, 22.0 ],
					"text" : "r spawn"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 290.5, 393.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 84.25, 393.0, 30.0, 30.0 ]
								}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "D:/Projekte/MaxMSP/MaxMSP-Projects/2404_MatrixSynth",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
