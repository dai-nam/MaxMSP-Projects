...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.0, 49.0, 57.0, 20.0 ],
					"text" : "read pk.jxf"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 131.0, 19.0, 121.0, 18.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "float" ],
									"patching_rect" : [ 79.0, 44.0, 32.5, 18.0 ],
									"text" : "t b f"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 79.0, 19.0, 49.0, 18.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 92.783019999999993, 66.0, 72.0, 16.0 ],
									"text" : "slide_down $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 13.0, 118.0, 62.0, 18.0 ],
									"text" : "jit.scanslide"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 159.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 79.0, 159.0, 25.0, 25.0 ]
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-30", 0 ],
									"midpoints" : [ 102.283019999999993, 104.0, 22.5, 104.0 ],
									"source" : [ "obj-25", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"floatoutput" : 1,
					"id" : "obj-50",
					"knobcolor" : [ 0.047058823529412, 0.913725490196078, 0.913725490196078, 0.63 ],
					"knobshape" : 5,
					"maxclass" : "slider",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/_Projekte/MaxMSP/2407_SpeechNMF/PVoc/SSP-Dissertation/5.2.2 - Spectral Smear",
				"patcherrelativepath" : ".",
				"type" : "maxb",
				"implicit" : 1
			}
