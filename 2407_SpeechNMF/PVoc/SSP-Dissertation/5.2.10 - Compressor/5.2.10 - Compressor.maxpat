...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 297.0, 184.0, 73.0, 18.0 ],
									"text" : "loadmess 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 349.0, 279.0, 62.0, 18.0 ],
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 343.0, 314.0, 79.0, 52.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 66.0, 40.0, 218.0, 18.0 ],
									"text" : "ratio (1 - no compression; 0 - infinity/limiter)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "float" ],
									"patching_rect" : [ 289.0, 339.0, 32.5, 18.0 ],
									"text" : "t b f"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 289.0, 314.0, 50.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 14.0, 40.0, 50.0, 18.0 ],
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
									"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 226.0, 364.0, 96.0, 18.0 ],
									"text" : "jit.op @op *"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 89.0, 426.0, 64.0, 18.0 ],
									"text" : "jit.op @op +"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 226.0, 389.0, 130.0, 18.0 ],
									"text" : "jit.clip @min 0 @max 2048"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 226.0, 339.0, 62.0, 18.0 ],
									"text" : "jit.op @op -"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 89.0, 275.0, 130.0, 18.0 ],
									"text" : "jit.clip @min 0 @max 2048"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 349.0, 213.0, 59.0, 18.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "float" ],
									"patching_rect" : [ 297.0, 245.0, 32.5, 18.0 ],
									"text" : "t b f"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 297.0, 213.0, 50.0, 18.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 226.0, 275.0, 104.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 15.0, 459.0, 50.0, 18.0 ],
									"text" : "jit.pack 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 487.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 62.0, 487.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 573.0, 70.0, 223.0, 294.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 5.0, 4.0, 288.0, 65.0 ],
									"rounded" : 20
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 89.0, 245.0, 50.0, 16.0 ],
									"text" : "max $1"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 0 ],
									"midpoints" : [ 34.5, 233.0, 235.5, 233.0 ],
									"order" : 0,
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 34.5, 270.0, 98.5, 270.0 ],
									"order" : 1,
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 235.5, 417.0, 143.5, 417.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 98.5, 451.0, 24.5, 451.0 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 298.5, 361.0, 71.5, 361.0 ],
									"source" : [ "obj-18", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 0 ],
									"midpoints" : [ 306.5, 238.0, 98.5, 238.0 ],
									"order" : 1,
									"source" : [ "obj-5", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 320.0, 266.0, 337.0, 266.0, 337.0, 299.0, 278.5, 299.0 ],
									"order" : 1,
									"source" : [ "obj-6", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-38", 0 ],
									"midpoints" : [ 306.5, 264.0, 71.5, 264.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 358.5, 305.0, 298.5, 305.0 ],
									"source" : [ "obj-9", 0 ]
								}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/_Projekte/MaxMSP/2407_SpeechNMF/PVoc/SSP-Dissertation/5.2.10 - Compressor",
				"patcherrelativepath" : ".",
				"type" : "maxb",
				"implicit" : 1
			}
