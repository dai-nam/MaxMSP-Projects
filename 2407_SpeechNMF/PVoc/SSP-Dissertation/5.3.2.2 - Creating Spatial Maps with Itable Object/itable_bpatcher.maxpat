{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 819.0, 181.0, 408.0, 199.0 ],
		"bglocked" : 0,
		"defrect" : [ 819.0, 181.0, 408.0, 199.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "if $i1 >= 1 && $i1 <= 179 then 1 else 0",
					"linecount" : 2,
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 632.0, 178.0, 111.0, 29.0 ],
					"id" : "obj-22",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "if $i1 >= 1 && $i1 <= 370 then 1 else 0",
					"linecount" : 2,
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 541.0, 226.0, 102.0, 29.0 ],
					"id" : "obj-37",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"numoutlets" : 1
