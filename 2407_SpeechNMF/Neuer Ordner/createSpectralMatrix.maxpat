...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 561.0, 483.0, 67.0, 20.0 ],
					"text" : "fftout~ 1 nofft"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 463.0, 477.0, 56.0, 20.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 664.0, 17.0, 27.0, 20.0 ],
					"text" : "in 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 743.0, 376.0, 53.0, 20.0 ],
					"text" : "zl change"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 743.0, 401.0, 30.0, 20.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 804.0, 352.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 743.0, 352.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 743.0, 308.0, 41.0, 20.0 ],
					"text" : "/ 1024."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 743.0, 247.0, 58.0, 20.0 ],
					"text" : "metro 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 743.0, 278.0, 88.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 535.0, 135.0, 32.5, 20.0 ],
					"text" : "i 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 549.0, 70.0, 27.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 518.0, 273.0, 41.0, 20.0 ],
					"text" : "sig~ -1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 48.0, 93.0, 46.0, 20.0 ],
					"text" : "t i 0 b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 504.0, 207.0, 44.0, 20.0 ],
					"text" : "/~ 1024"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 504.0, 184.0, 50.0, 20.0 ],
					"text" : "count~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 535.0, 160.0, 32.5, 20.0 ],
					"text" : "*"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 585.0, 70.0, 59.5, 20.0 ],
					"text" : "fftinfo~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 131.0, 184.0, 64.0, 20.0 ],
					"text" : "framedelta~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 131.0, 207.0, 65.0, 20.0 ],
					"text" : "phasewrap~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 98.0, 160.0, 52.0, 20.0 ],
					"text" : "cartopol~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 48.0, 135.0, 32.5, 20.0 ],
					"text" : "!- 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 70.0, 27.0, 20.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 404.0, 354.0, 60.0, 20.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 342.0, 354.0, 60.0, 20.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 279.0, 354.0, 60.0, 20.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.0, 385.0, 144.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 202.0, 354.0, 60.0, 20.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 140.0, 354.0, 60.0, 20.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 77.0, 354.0, 60.0, 20.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.0, 385.0, 144.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 98.0, 135.0, 85.0, 20.0 ],
					"text" : "fftin~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 664.0, 39.0, 80.0, 20.0 ],
					"text" : "matrix_name $1"
				}
