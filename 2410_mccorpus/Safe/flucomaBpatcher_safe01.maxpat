...
,
		"classnamespace" : "box",
		"rect" : [ -1806.0, 302.0, 1362.0, 908.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 606.0, 116.0, 24.0, 24.0 ]
				}
...
,
					"patching_rect" : [ 606.0, 339.0, 196.0, 22.0 ],
...
,
					"patching_rect" : [ 606.0, 297.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 606.0, 256.0, 139.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 488.0, 408.0, 150.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 654.0, 408.0, 75.0, 22.0 ],
									"text" : "buffer~ mfcc"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 76.0, 407.0, 396.0, 22.0 ],
...
,
					"patching_rect" : [ 606.0, 211.0, 62.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 66.0, 73.0, 83.0, 22.0 ],
					"text" : "route bang 1d"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 573.0, 58.0, 150.0, 20.0 ],
					"text" : "Todo: Reduce to 1D"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.0, 657.0, 30.0, 30.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 508.0, 151.0, 105.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 19.0, 151.0, 436.0, 22.0 ],
									"text" : "fluid.bufonsetslice~ @metric 9 @threshold 0.6 @source sel @indices slicepoints"
								}
...
,
					"patching_rect" : [ 66.0, 168.0, 91.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 138.0, 211.0, 326.0, 37.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1131.0, 45.0, 128.0, 128.0 ],
					"presentation" : 1,
